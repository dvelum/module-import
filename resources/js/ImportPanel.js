...
Ext.define('dvelum.import.Panel',{
    ...
    /**
     * Settings panel
     * @var {dvelum.import.SettingsPanel}
     */
    settingsPanelCmp:null,
    /**
    ...
    initComponent:function(){
        ...
        this.yesIcon = '/resources/dvelum-module-import/images/yes.gif';
    ...
    initFormFields:function(){
        ...
        if(this.settingsPanel){
            ...
            formFields.push(this.settingsPanelCmp);
        }
    ...
    uploadFile:function(){
        ...
        this.uploadForm.getForm().submit({
            ...
            url:this.controllerUrl + this.controllerActions.upload,
     ...
     * @param {Array} result
     * @param {int} colCount - columns count
     * @param {int} uploadId - uploaded file ID
    ...
    sendSaveSettingsRequest:function(callback){
        var me = this;
        var settingsConfig = this.settingsPanelCmp.getSettingCfg();
        var requestParams = Ext.apply(params, this.getForm().getValues());

        requestParams.setting_id = settingsConfig.id;
        requestParams.setting_title = settingsConfig.title;
     ...
     * @param {Object} params - import settings
     */
    sendImportRequest:function(params){
        var handle = this;
    ...
    destroy:function(){
        ...
        var toDestroy  = [
            this.uploadForm,
            this.importForm,
            this.importFieldsContainer,
            this.expectedColsContainer,
            this.gridContainer,
            this.importFormContainer,
            this.settingsPanelCmp
        ];
